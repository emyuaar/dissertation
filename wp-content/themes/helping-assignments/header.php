    ...
    <div class="container ha-header-main">
        ...
        <div class="ha-logo">
            <a href="<?php echo home_url(); ?>">
                <img src="https://onlinedissertationadvisors.co.uk/wp-content/uploads/2026/05/Online-Dissertation-Advisors-Logo-Png.webp" style="height: 100px; width: 200px;" alt="Online Dissertation Advisors">
            </a>
        </div>
